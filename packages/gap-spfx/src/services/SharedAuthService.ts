...
export class AuthService {
  ...
  public async authenticateToDataverse(): Promise<string> {
    if (!this.accessToken) {
      this.accessToken = await this.getAccessToken(gapDataverseConfig.resourceUrl);
    }
...
export const gapDataverseConfig = {
  apiUrl: 'https://orgda56a300.crm6.dynamics.com',
  resourceUrl: 'https://orgda56a300.crm6.dynamics.com',
  environment: 'https://orgda56a300.crm6.dynamics.com',
  apiVersion: 'v9.1',
  tables: {
    hounds: 'cr0d3_hound'  // Singular - Dataverse will pluralize to cr0d3_hounds
  }
};